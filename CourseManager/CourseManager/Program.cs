...
// 3. IDENTITY (Unver�ndert, aber wichtig f�r den Context)
...
// 4. BACKGROUND SERVICES AUSGESCHALTET (k�nnen bei Bedarf wieder aktiviert werden)
...
builder.Services.AddCascadingAuthenticationState(); // Wichtig f�r Blazor & Identity
    ...
    SignInManager<Teacher> signInManager) =>
{
    ...
    // Bei Fehlern zur�ck zur Seite mit Fehlermeldung
